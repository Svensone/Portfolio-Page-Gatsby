...
const DEFAULT_IMAGES = [
    ...
    description: 'ResNet34 CNN trained on balinese dance-style images, accuracy 86% - made with fastai, pytorch, Python', link: 'http://b3eb0f5587b2.ngrok.io/' },
    { id: '8', src: full08, thumbnail: thumb08, 
    caption: 'Computer Vision Medical Pneumonia detection', 
    description: 'Pneumonia Detectin - Coming Soon', 
    link: 'coming soon'},
