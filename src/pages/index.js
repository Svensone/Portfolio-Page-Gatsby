...
const DEFAULT_IMAGES = [
    ...
    { id: '4', src: full03, thumbnail: thumb03, caption: 'Rocket App', 
    description: 'ReactJS-GraphQl App displaying all launches of Elon Musks Space-X', 
    link: 'https://space-x-app-sven.herokuapp.com/launch/1'},
    ...
    description: 'HTML / CSS / JS Site with anime.js and other animations', link: ''},
];
